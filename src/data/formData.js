...
export const  grundKurser = [
    {
        ...
        kursID: 'grund',
        kursPris: '9500',
        kursComment: 'OBS! Det tillkommer en kostnad på 200 kr för varje höjdflyg detta betalas vid kursavslut. I detta pris ingår utrustning och instruktör. Under kursen gör man 1-10 st höjdflyg. Det tillkommer också transport till startplatser på berget, 90 kr/st med bil och 200 kr/st med lift. Innan man börjar kursen, måste man också teckna ett "Take off kit" hos SSFF. Det kostar 2.071 kr (för kalenderår 2026) och inkluderar försäkring, medlemskap i SSFF och licensavgift. Mera information om Take off kit får du när du har bokat kursen.',
    },
