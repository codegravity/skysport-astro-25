...
const htmlNewsKundTemplate = ( email, BookingTimestamp) => {
    return `
...
&nbsp; 
  <p>Detta är en automatisk anmälnings bekräftelse för Skysports nyhetsbrev.</p>

        
<h4>Du här anmält följande epost adress: ${email}</h4>
