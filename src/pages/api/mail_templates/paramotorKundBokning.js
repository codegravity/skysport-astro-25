        ...
        <tbody>
          <tr>
            <td style="width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 40px;" width="596">
             ...
             Hej ${name}</h2>
             <h4>
Tack att du har bokat Paramotor grundkurs hos Skysport.
...
&nbsp; 
  <p>Detta är en automatisk bokningsbekräftelse Paramotor kurs hos Skysport</p>
