...
<head>
  ...
  <!--[if !mso]><!--><meta http-equiv="X-UA-Compatible" content="IE=edge"><!--<![endif]-->
    ...
    <title>Bokningsbekräftelse skärmflyg resa hos Skysport</title>
    <!-- End title -->
        ...
        <tbody>
          <tr>
            <td style="width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 40px;" width="596">
             ...
             Hej ${name}</h2>
             <h4>
Tack att du har din skärmflyg resa hos Skysport.
Du har skickat följande bokningsuppgifter.
Om nånting är fel eller inte stämmer gärna kontakt oss på: bokning@skysport.se
Vi kommer snart att skicka ut mer information till dig.
mvh
Skysport AB
</h4>
&nbsp; 
  <p>Detta är en automatisk bokningsbekräftelse för Skärmflyg resa hos Skysport</p>
...
<h4>Du här bokad med följande informationen:</h4>
  ...
  Email: <i>${email}</i><br>
   ...
   Födelseår: <i>${birthyr}</i>
   </p>
   <p class="p1">
  Meddelande: <i>${Meddelande}</i>
  </p>
   <p class="p1">
   Resvilkor godkänd: <i>${vilkor}</i><br>
   Bokningsvillkor godkänd: <i>${checkboxOK}</i><br>
