...
const htmlSpeedSkyTemplate = (kursDate, kursName, kursPriceISO, name, tel, telday, email, Meddelande,  weight, birthyr, adress, postnr, city, country, kursvilkor, newsletter,checkboxOK, BookingTimestamp) => {
    return ` 
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <tbody>
                ...
                <tr style="height: 300px;">
                    <td align="left" style="border: none;
                        ...
                        <p style="font-weight: bolder; font-size: 18px; letter-spacing: 0.025em; color:black;">
                         Vikt:  ${weight} <br>   <br> Födelseår: ${birthyr}
                        </p>
                        <p style="font-weight: bolder; font-size: 18px; letter-spacing: 0.025em; color:black;">
                ...
                <tr style="display: inline-block;">
                    <td style="min-height: 150px; padding: 6px 20px; border: none; border-bottom: 2px solid #361B0E; background-color: white;">
                        <h2 style="text-align: left; align-items: center;">Kursdate: ${kursDate} &nbsp; </h2>
                        <p class="data" style="text-align: justify-all;  align-items: center;  font-size: 18px;  padding-bottom: 6px;">
                            ${kursName} kurspris: ${kursPriceISO}
                       </p>
