...
const htmlSpeedKundBookTemplate = (kursDate, kursName, kursPriceISO, name, tel, telday, email, Meddelande, weight,  birthyr, adress, postnr, city, country, kursVilkor, newsletter,checkboxOK, BookingTimestamp) => {
    return `
        ...
        <tbody>
          <tr>
            <td style="width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 40px;" width="596">
             ...
             Hej ${name}</h2>
             <h4>
Tack att du har bokat ${kursName} hos Skysport.
...
&nbsp; 
  <p>Detta är en automatisk bokningsbekräftelse Speed kurs hos Skysport</p>

        
<h4>Du här bokad med följande informationen:</h4>

  <p class="p1">
  ${kursName} bokad datum: <b>${kursDate}</b> &nbsp; <br>
  ${kursName} pris: <b>${kursPriceISO}</b><br>
