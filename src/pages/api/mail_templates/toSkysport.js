const htmlTemplate = (kontaktNamn, kontaktTel, kontaktEpost,kontaktMeddelande,kontaktTimestamp) => {
    return ` <!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
            ...
            <tbody>
                ...
                <tr style="display: inline-block;">
                    <td style="height: 150px; padding: 20px; border: none; border-bottom: 2px solid #361B0E; background-color: white;">
                        <h2 style="text-align: left; align-items: center;">Från: ${kontaktNamn}</h2>
